...
<html>
	<head>
		<link rel='stylesheet' href='cpu_ud.css'></link>
		...
		<form action="#" method="POST" enctype='multipart/form-data'>
			<?php
				if(isset($_POST["UpdateCPU"]))
				{
					...
					$url="../upload/cpu/".$file_name;
					
					move_uploaded_file($tmp_name,$path);
					
					
					$query="update cpu set series='$series',name='$name',cores_threads='$cores_threads',stock_freq='$stock_freq',boost_freq='$boost_freq',transistor_size='$transistor_size',total_cache='$total_cache',l1='$l1',l2='$l2',l3='$l3',cooler='$cooler',TDP='$TDP',prize='$prize',in_stock='$in_stock',type='$hardware_type',img='$url' where no='$id'";
					
					//$query="update cpu set series='$series', name='$name', cores_threads='$cores_threads', stock_freq='$stock_freq', boost_freq='$boost_freq', transistor_size='$transistor_size', total_cache='$total_cache', l1='$l1', l2='$l2', l3='$l3', cooler='$cooler', TDP='$TDP', prize='$prize', in_stock='$in_stock', type='$hardware_type' where no='$id'";
						...
						?>
							<div class='main_container'>
								...
								<div class='row'>
									<div class='col3'>
										<div class='group'>
											<input type='text' name='in_stock' id='' class='input' required value="<?php echo $temp[15]; ?>">
											<span class='bar col3bar'></span>
											<label>Stocks</label>
										</div>
									</div>
